...
/*   Updated: 2022/08/13 00:05:40 by azabir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/28 09:46:02 by yagnaou           #+#    #+#             */
/*   Updated: 2022/08/13 00:04:12 by azabir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_parce(t_data *data)
{
	...
	while (temp && (temp->id != -1))
	{
		...
		j = 0; 
		tmp = "";
		data->full_cmd = (char **)malloc((sizeof(char *) * cmd_parts_count(temp) + 1));
		while (temp->id != -1 && (temp->id != 8))
		{
			printf("cmd = %s >>>>>> id = %d\n", temp->cmd, temp->id);
			if (temp->id == 9)
			...
			{
				data->full_cmd[j] = cmd_array_join(temp->cmd);
				j++;
			}
			temp = temp->next;
			/*if (temp->id == 14)
